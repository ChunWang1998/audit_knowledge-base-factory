...
## 2. Oracle void outcome leaves PredictionMarketV3ManagerCLOB.voidedPayouts unset, locking collateral
...
## 3. Timestamp boundary condition causes reward dilution for active operators
